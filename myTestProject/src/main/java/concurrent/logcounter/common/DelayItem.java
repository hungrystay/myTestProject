...
*/
package concurrent.logcounter.common;
...
public class DelayItem {
	...
	private int intSampleCount = 0;
	private long intTotalDelay = 0;

	public int getIntSampleCount() {
		return intSampleCount;
	}

	public void setIntSampleCount(int intSampleCount) {
		this.intSampleCount = intSampleCount;
	}

	public long getIntTotalDelay() {
		return intTotalDelay;
	}

	public void setIntTotalDelay(long intTotalDelay) {
		this.intTotalDelay = intTotalDelay;
	}
