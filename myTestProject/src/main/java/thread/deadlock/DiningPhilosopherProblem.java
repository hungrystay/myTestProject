...
public class DiningPhilosopherProblem {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String philosopherImplClassName = args[0];
    for (int i = 0; i < numOfPhilosopers; i++) {
      // 创建哲学家
      createPhilosopher(philosopherImplClassName, i, chopsticks).start();
    }
  }

  private static AbstractPhilosopher createPhilosopher(String philosopherImplClassName,
    ...
    AbstractPhilosopher philosopher = constructor.newInstance(id, chopsticks[id],
          chopsticks[(id + 1)
              % numOfPhilosopers]);
